...
app.get("/csvqueries", async (req, res) => {
  try {
    ...
    let query = `SELECT dbo.tblSchool.sch_name, dbo.tblWellInfo.wi_wellcode, dbo.tblWellInfo.wi_wellname, dbo.tblWellInfo.wi_well_user, dbo.tblWellInfo.wi_address, dbo.tblWellInfo.wi_city, dbo.tblWellInfo.wi_state,
                  ...
                  dbo.tblFieldActivity.fa_datacollector, dbo.tblFieldActivity.fa_observation, dbo.tblFieldActivity.fa_datecollected, dbo.tblFieldActivity.fa_topography, dbo.tblClassroomLab.cl_calciumhardness, dbo.tblClassroomLab.cl_chloride,
...
app.get('/allImageMetadata', async (req, res) => {
  let query = `SELECT        dbo.tblWellInfo.school_id, dbo.tblSchool.sch_name, dbo.tblWellInfo.well_id, dbo.tblWellInfo.wi_wellcode, dbo.tblWellInfo.wi_wellname, dbo.tblImage.im_type, dbo.tblImage.im_latitude, dbo.tblImage.im_longitude,
...
FROM            dbo.tblWellInfo INNER JOIN
                         ...
                         dbo.tblSchool ON dbo.tblWellInfo.school_id = dbo.tblSchool.school_id WHERE dbo.tblWellInfo.school_id = ${kywmemValue};`;
