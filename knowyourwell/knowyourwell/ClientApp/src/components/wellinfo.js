...
export default function WellInfo() {
    ...
    function addWellInfo() {  /*const addWellInfo = () =>*/
        Axios.post('/createwellinfo', {
            school_id: school_id,
            wi_wellcode: wellcode,
            wi_wellname: wellname,
            wi_welluser: welluser,
            wi_address: address,
            wi_city: city,
            wi_state: state,
            wi_zipcode: zipcode,
            wi_countyid: county,
            wi_nrdid: nrd,
            wi_wellowner: wellowner,
            wi_installyear: installyear,
            wi_smelltaste: smelltaste,
            wi_smelltastedescription: smelltaste_description,
            wi_welldry: welldry,
            wi_welldrydescription: welldry_description,
            wi_maintenance5yr: maintenance5yr,
            wi_landuse5yr: landuse5yr,
            wi_numberwelluser: numberwelluser,
            wi_pestmanure: pestmanure,
            wi_estlatitude: estlatitude,
            wi_estlongitude: estlongitude,
            wi_boreholediameter: boreholediameter,
            wi_totaldepth: totaldepth,
            wi_topography: topography,
            wi_waterleveldepth: well_waterleveldepth,
            wi_aquifertype: aquifertype,
            wi_aquiferclass: aquiferclass,
            wi_welltype: welltype,
            wi_wellcasematerial: wellcasematerial,
            wi_datacollector: datacollector,
            wi_observation: observation,
            wi_dateentered: dateentered,
        })
            .then(() => {
                console.log("success");
            })
