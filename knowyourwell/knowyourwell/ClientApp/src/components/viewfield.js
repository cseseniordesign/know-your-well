    ...
    if (formElements.length != 0) {
        ...
        for (let i = 0; i < labelList.length; i += 2) {
            ...
            if (firstColumnName == "Date Entered:")
                firstColumnValue = moment.utc(formElements["fa_datecollected"]).format('MM-DD-YYYY hh:mm A')
            ...
            if (secondColumnName == "Date Entered:")
                secondColumnValue = moment.utc(formElements["fa_datecollected"]).format('MM-DD-YYYY hh:mm A')
