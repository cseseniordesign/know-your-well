...
import logo from './kywlogo.png'; // Tell Webpack this JS file uses this image
...
```css
.Logo {
  background-image: url(./kywlogo.png);
}
```
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + '/img/kywlogo.png'} />;
}
```
